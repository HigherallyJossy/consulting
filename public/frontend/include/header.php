            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-2 col-md-2 col-xs-12 col-sm-12">
                     <div class="logo">
                         <a href="index.php"><img src="image/GSIT-FullLogo-1.jpg" class="image-responsive" alt="logo" /></a>
                     </div>
                  </div>
                     ...
                     <div class="right-header">
                        <div class="header-info">
                           ...
                           <div class="info-inner ">
                              ...
                              <span class="iconcont">Wilmington, DE 1108<br><a>Global State IT Solutions Bridge Street.</a></span>
                           </div>
                           <div class="info-inner">
               ...
               <div class="container">
                  <div class="row">
                     <div class="site-logo col-md-3 col-sm-6 col-xs-6">
                        <a href="#" class="logo">
                           <img src="image/svg1/GSIT-FullLogo.jpg"  alt="logo"  class="logo-dark show-logo" />
                        </a>
                           ...
                           <ul id="primary-menu" class="menu pull-left">
                                    ...
                                    <li class="dropdown-item">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="mission&valves.php">Mission & Values</a></li>
                                    ...
                                    <li><a href="our-career.php">Our Career</li>
                                    <li class="dropdown-item">
